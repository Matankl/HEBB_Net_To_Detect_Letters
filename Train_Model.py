...
# Test the network
print("\ntesting with the training set")
test_hebbian_network(letters, model_one_epoch, model_with_augmentation, convert_imag_to_vector, get_output, calculate_accuracy, calculate_f1)

print("\ntesting with 5% noise")
test_hebbian_network(vectors5, model_one_epoch, model_with_augmentation, convert_imag_to_vector, get_output, calculate_accuracy, calculate_f1)

print("\ntesting with 10% noise")
test_hebbian_network(vectors10, model_one_epoch, model_with_augmentation, convert_imag_to_vector, get_output, calculate_accuracy, calculate_f1)

print("\ntesting with 20% noise")
test_hebbian_network(vectors20, model_one_epoch, model_with_augmentation, convert_imag_to_vector, get_output, calculate_accuracy, calculate_f1)
